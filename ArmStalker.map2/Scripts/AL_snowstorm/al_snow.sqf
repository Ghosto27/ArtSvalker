...
////null = [80,1800,false,300,true] execvm "Scripts\AL_snowstorm\al_snow.sqf";
// null = [direction_monsoon, duration_monsoon, effect_on_objects] execvm "Scripts\AL_snowstorm\al_monsoon.sqf";
...
null = [] execVM "Scripts\AL_snowstorm\alias_hunt.sqf";
null = [] execvm "Scripts\AL_snowstorm\umblator.sqf";
...
[] spawn {
	...
	if (terrain_type_vanilla) then {
		...
		[[[_rotocol],"Scripts\AL_snowstorm\rotocol.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
		[[[_rotocol_1],"Scripts\AL_snowstorm\rotocol.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
		sleep 1.5;
...
[[[],"Scripts\AL_snowstorm\alias_snowstorm_effect.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;

if (breath_vapors_units) then {
	{[[[_x],"Scripts\AL_snowstorm\snow_breath.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;sleep 0.5} forEach allUnits;
};
