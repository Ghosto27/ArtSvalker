// by ALIAS
// nul = [] execvm "scripts\AlNuke\weather_nuke.sqf";
...
if (!hasInterface) exitWith {};
	...
	leaves_p setParticleParams [["\A3\data_f\ParticleEffects\Hit_Leaves\Sticks_Green", 1, 1, 1], "", "SpaceObject", 1,27,[0,0,0],[50,50,10],2,0.000001,0.0,0.1,[0.5+random 5],[[0.68,0.68,0.68,1]],[1.5,1],13,13,"","",vehicle player,0,true,1,[[0,0,0,0]]];
					
	Leaves_Green setDropInterval random 0.3;
	Leaves_leaf setDropInterval random 0.3;
	WoodParts setDropInterval random 0.3;
