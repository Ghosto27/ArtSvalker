	...
	*/
	...
	class FREEDOMs_BARMEN 
	{
		ShowcaseType = "AGM_BOX_MISC"; 				//showcase must be placed near trader (<10m)
		ItemUp = 0.1;											//showed item  height relatively showcase
		...
		class Buy 
		{
			...
			class Artefacts {
				...
				items[] = {
					...
					//Artefacts
					//anomylki
					{"Item_TEARS_Unstab",0.4},
					{"Item_Medusa_Unstab",1.1},
					{"Item_GRAVI_Unstab",1.8},
